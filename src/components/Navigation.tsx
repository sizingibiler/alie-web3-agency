...
{navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="relative font-inter font-medium text-neutral-gray hover:text-quantum-white transition-colors duration-200 group"
                >
                  {link.label}
                  <motion.span
              ...
              <div className="flex flex-col p-8 pt-24 space-y-6">
                {navLinks.map((link) => (
                  <Link
                    ...
                    className="text-2xl font-inter font-medium text-neutral-gray hover:text-quantum-white transition-colors"
                  >
                    {link.label}
                  </Link>
                ))}
