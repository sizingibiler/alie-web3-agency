...
const footerLinks = {
  services: [
    { label: 'Data-Driven KOL Campaigns', href: '#' },
    { label: 'Bespoke KOL Campaigns', href: '#' },
    { label: 'Exchange Listing Support', href: '#' },
    { label: 'Angel Investor Matchmaking', href: '#' },
    { label: 'High-Impact Ad Campaigns', href: '#' },
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-neutral-gray text-sm">
              © 2025 Alie Web3 Agency. All rights reserved.
            </p>
